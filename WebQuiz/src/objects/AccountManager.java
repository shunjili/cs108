...
public class AccountManager {
	...
	public static boolean makePrivate(String username) {
		try {
			try {
				Class.forName("com.mysql.jdbc.Driver");
			} catch (ClassNotFoundException e) {
			...
			//prepare query
			String query = "UPDATE " + MyDBInfo.ACCOUNTS_TABLE + " SET " + ISPRIVATE_COL + "=1 WHERE "
					+ USERNAME_COL + "=\"" + username + "\";";
	...
	public static boolean makePublic(String username) {
		try {
			try {
				Class.forName("com.mysql.jdbc.Driver");
			} catch (ClassNotFoundException e) {
			...
			//prepare query
			String query = "UPDATE " + MyDBInfo.ACCOUNTS_TABLE + " SET " + ISPRIVATE_COL + "=0 WHERE "
					+ USERNAME_COL + "=\"" + username + "\";";
