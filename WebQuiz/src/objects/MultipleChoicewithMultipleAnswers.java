...
public class MultipleChoicewithMultipleAnswers implements Question{
	...
	public MultipleChoicewithMultipleAnswers(String questionID, String question, String description,
		...
		this.type = Question.Type.MULTIPLE_CHOICE_MULTIPLE_ANSWER;
		this.score = score;
	...
	public String getDescription() {
		return Integer.toString(this.description);
	}
	...
	public String getHTML(boolean answer) {
		...
		if(choices != null){
			for (int i = 0; i < choices.length; i++){
				html +=String.format("<div class=\"input-group\"><span class=\"input-group-addon\"><input type=\"checkbox\" name = %s value = %d></span><label type=\"text\" class=\"form-control\">%s</label></div><br>", questionID, i+1, choices[i]) ;
			}
		}
