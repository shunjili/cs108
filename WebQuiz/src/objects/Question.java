...
public interface Question {
	public enum Type{QUESTION_RESPONSE, FILL_IN_BLANK, MULTIPLE_CHOICE, PIC_RESPONSE, MULTIPLE_ANSWER, MULTIPLE_CHOICE_MULTIPLE_ANSWER, BAD_TYPE};
	...
	public static final String MULTIPLE_ANSWER_STR = "MULTIPLE_ANSWER";
	public static final String PIC_RESPONSE_STR = "PIC_RESPONSE";
	public static final String MULTIPLE_CHOICE_MULTIPLE_ANSWER_STR = "MULTIPLE_CHOICE_MULTIPLE_ANSWER";
