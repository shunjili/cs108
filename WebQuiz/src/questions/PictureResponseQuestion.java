...
public class PictureResponseQuestion extends Question{
	...
	public PictureResponseQuestion(int question_id, String question, String ans,
		...
		this.type = "PictureResponseQuestions";
		this.score = score;
		this.timestamp = timestamp;
	}
	
	public PictureResponseQuestion(String question, String ans, String description,
			String creator) {	
		super();
		this.question = question;
		this.answers = new ArrayList<String>();
		...
		this.description = description;
		this.creator = creator;
		this.type = "PictureResponseQuestion";
		this.score = DEFAULT_SCORE;
		this.timestamp =  new Timestamp(new Date().getTime());
	}
	
	public PictureResponseQuestion(int question_id) {
		
		super(question_id);
		answers = new ArrayList<String>();
		String query = "SELECT * FROM Questions INNER JOIN Answers " +
				"ON Questions.question_id = Answers.question_id " +
				"WHERE question_id =\"" + question_id + "\" AND type = PictureResponseQuestion";
		connect();
		try{
			...
			String[] parts = ans.split(";"); // suddenly found that we have another questionAns table, may fix later
			int len = parts.length;
			for(int i = 0; i < len ; i++){
				answers.add(parts[i]);
			}*/
...
*/
	...
	public String getView(int QuesinQuiz) {
		...
		String htmlContent = "<p>Q" + Integer.toString(QuesinQuiz) + ": " + question + "</p>" + 
				"<div><img src = \"" + this.description + "\"></div>" + 
	...
	public String getAnsView(int QuesinQuiz) {
		...
		htmlContent += "<div><img src = \"" + this.description + "\"></div>"; 
	...
	@Override
	public ArrayList<String> getUserAnswer(HttpServletRequest request,	//the reasion is for multi answer extension
			int QuesinQuiz) {
		// TODO Auto-generated method stub
	...
	public static void main(String[] args){
		...
		sol.add("dell");
		String answers = "dell";
		String description = "https://lh6.googleusercontent.com/-qA6BZB27IPw/AAAAAAAAAAI/AAAAAAAAKYE/FpK1qXct5t4/s120-c/photo.jpg";
		String creator = "Shuhui";
		int score = 5;
		Timestamp temp = new Timestamp(new Date().getTime());
		PictureResponseQuestion test = new PictureResponseQuestion(id, questions,answers,description, creator, score, temp);
		System.out.println(test.getView(2));
		System.out.println(test.getResultView(2,sol));
		
		PictureResponseQuestion test1 = new PictureResponseQuestion(questions,answers,description, creator);
