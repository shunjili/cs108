...
public class QuestionResponseQuestion extends Question{
	...
	public QuestionResponseQuestion(int question_id, String question, String ans,
		...
		this.type = "QuestionResponseQuestion";
		this.score = score;
		this.timestamp = timestamp;
	}
	
	public QuestionResponseQuestion(String question, String ans,
			String creator) {	
		super();
		this.question = question;
		this.answers = new ArrayList<String>();
	...
	public QuestionResponseQuestion(int question_id) {
...
*/
	...
	@Override
	public ArrayList<String> getUserAnswer(HttpServletRequest request,	//maybe get from servlet is easier
			int QuesinQuiz) {
		// TODO Auto-generated method stub
	...
	public static void main(String[] args){
		...
		QuestionResponseQuestion test = new QuestionResponseQuestion(id, questions,answers,description, creator, score, temp);
		System.out.println(test.getView(2));
		QuestionResponseQuestion test1 = new QuestionResponseQuestion(questions, answers, creator);
		test.addQuestionAndAnswer(test.getId());
		test.addQuestionAndAnswer(test1.getId());
		System.out.println(test1.getView(2));
